...
public:
    ...
    FixedPoint24p8 operator + (const FixedPoint24p8 &arg2)
    {
        return FixedPoint24p8(data + arg2.data);
    }
    ...
    FixedPoint24p8 operator * (const FixedPoint24p8 &arg2)
    {
        uint64_t result = data * arg2.data;
        return FixedPoint24p8((uint32_t)result >> SHIFT_BITS);
    }

    FixedPoint24p8 mulFast (const FixedPoint24p8 &arg2)
    {
        return FixedPoint24p8((data * arg2.data) >> SHIFT_BITS);
    }

    FixedPoint24p8 fromUInt(uint32_t value)
    {
        return FixedPoint24p8(value << SHIFT_BITS);
    }
